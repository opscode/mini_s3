...
expiration_time_v4_test() ->
   ...
   % {_,    1} = mini_s3:expiration_time_v4({0,       1}),
   % {_,    1} = mini_s3:expiration_time_v4({1,       1}),
   % {_,    2} = mini_s3:expiration_time_v4({2,       1}),
   % {_,  100} = mini_s3:expiration_time_v4({0,     100}),
   % {_,  100} = mini_s3:expiration_time_v4({99,    100}),
   % {_,  100} = mini_s3:expiration_time_v4({100,   100}),
   % {_,   L0} = mini_s3:expiration_time_v4({101,   100}),
   % true = L0 >= 101,
   % {_, 1000} = mini_s3:expiration_time_v4({0,    1000}),
   % {_, 1000} = mini_s3:expiration_time_v4({999,  1000}),
   % {_, 1000} = mini_s3:expiration_time_v4({1000, 1000}),
   % {_,   L1} = mini_s3:expiration_time_v4({1001, 1000}),
   % true = L1 >= 1001.
